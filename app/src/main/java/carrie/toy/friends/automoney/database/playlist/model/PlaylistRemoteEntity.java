package carrie.toy.friends.automoney.database.playlist.model;
...
import carrie.toy.friends.automoney.database.playlist.PlaylistLocalItem;
import carrie.toy.friends.automoney.util.Constants;

import static carrie.toy.friends.automoney.database.playlist.model.PlaylistRemoteEntity.REMOTE_PLAYLIST_NAME;
import static carrie.toy.friends.automoney.database.playlist.model.PlaylistRemoteEntity.REMOTE_PLAYLIST_SERVICE_ID;
import static carrie.toy.friends.automoney.database.playlist.model.PlaylistRemoteEntity.REMOTE_PLAYLIST_TABLE;
import static carrie.toy.friends.automoney.database.playlist.model.PlaylistRemoteEntity.REMOTE_PLAYLIST_URL;
