...
import static carrie.toy.friends.automoney.player.helper.PlayerHelper.formatPitch;
import static carrie.toy.friends.automoney.player.helper.PlayerHelper.formatSpeed;
...
public abstract class ServicePlayerActivity extends AppCompatActivity
    ...
    private void admob_ad(){
        ...
        android.widget.RelativeLayout layout = (android.widget.RelativeLayout)findViewById(R.id.ad_layout);
