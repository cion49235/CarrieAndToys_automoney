...
import static carrie.toy.friends.automoney.database.history.model.SearchHistoryEntry.CREATION_DATE;
import static carrie.toy.friends.automoney.database.history.model.SearchHistoryEntry.ID;
import static carrie.toy.friends.automoney.database.history.model.SearchHistoryEntry.SEARCH;
import static carrie.toy.friends.automoney.database.history.model.SearchHistoryEntry.SERVICE_ID;
import static carrie.toy.friends.automoney.database.history.model.SearchHistoryEntry.TABLE_NAME;
